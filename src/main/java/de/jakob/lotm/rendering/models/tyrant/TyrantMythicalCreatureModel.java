...
import de.jakob.lotm.rendering.models.sun.SunMythicalCreatureAnimations;
...
public class TyrantMythicalCreatureModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath(LOTMCraft.MOD_ID, "tyrant_mythical_creature"), "main");
