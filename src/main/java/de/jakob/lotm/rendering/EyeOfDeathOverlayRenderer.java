...
public class EyeOfDeathOverlayRenderer {
    ...
    public static void onRegisterGuiLayers(RegisterGuiLayersEvent event) {
        event.registerAbove(VanillaGuiLayers.HOTBAR, Identifier.fromNamespaceAndPath(LOTMCraft.MOD_ID, "eye_of_death_overlay"), (guiGraphics, deltaTracker) -> {
    ...
    private static void renderOverlay(GuiGraphics guiGraphics) {
        ...
        Identifier backgroundTexture = Identifier.fromNamespaceAndPath(LOTMCraft.MOD_ID, "textures/gui/eye_of_death_overlay.png");
