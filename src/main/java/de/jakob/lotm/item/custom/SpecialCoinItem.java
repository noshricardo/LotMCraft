...
public class SpecialCoinItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (creatorUUID.equals(user.getUUID())) {
            user.sendSystemMessage(Component.literal("This coin is yours.").withStyle(ChatFormatting.GRAY));
    ...
    private static void triggerPrayer(ServerPlayer sender, ServerPlayer target) {
        ...
        target.sendSystemMessage(
                Component.empty()
                        .append(Component.literal("Someone used your connected coin... ")
