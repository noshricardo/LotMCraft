...
public class UnshadowedSpearProjectileRenderer extends EntityRenderer<UnshadowedSpearProjectileEntity, net.minecraft.client.renderer.entity.state.EntityRenderState> {
