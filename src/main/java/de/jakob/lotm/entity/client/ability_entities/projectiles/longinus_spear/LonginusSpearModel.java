...
public class LonginusSpearModel extends EntityModel<LonginusSpearProjectileEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(LOTMCraft.MOD_ID, "longinus_spear"), "main");
    private final ModelPart spear;

    public LonginusSpearModel(ModelPart root) {
        super();
        this.spear = root;
    }
    ...
    @Override
    public void setupAnim(LonginusSpearProjectileEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
