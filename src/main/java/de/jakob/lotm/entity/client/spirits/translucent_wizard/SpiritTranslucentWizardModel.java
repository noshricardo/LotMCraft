...
public class SpiritTranslucentWizardModel<T extends SpiritTranslucentWizardRenderState> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath(LOTMCraft.MOD_ID, "spirit_translucent_wizard"), "main");
	...
	public SpiritTranslucentWizardModel(ModelPart root) {
		...
		this.walkAnimation = SpiritTranslucentWizardAnimations.WALK.bake(root);
		this.idleAnimation = SpiritTranslucentWizardAnimations.IDLE.bake(root);
	}
