...
public class FlamingSpearProjectileRenderer extends EntityRenderer<FlamingSpearProjectileEntity> {
    ...
    @Override
    public @NotNull Identifier getTextureLocation(@NotNull FlamingSpearProjectileEntity entity) {
        return Identifier.fromNamespaceAndPath(LOTMCraft.MOD_ID, "textures/entity/flaming_spear/flaming_spear.png");
    }
}