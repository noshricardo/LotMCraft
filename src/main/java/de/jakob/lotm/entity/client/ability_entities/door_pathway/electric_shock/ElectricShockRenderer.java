...
public class ElectricShockRenderer extends EntityRenderer<ElectricShockEntity, net.minecraft.client.renderer.entity.state.EntityRenderState> {
    ...
    @Override
    public Identifier getTextureLocation(ElectricShockEntity entity) {
