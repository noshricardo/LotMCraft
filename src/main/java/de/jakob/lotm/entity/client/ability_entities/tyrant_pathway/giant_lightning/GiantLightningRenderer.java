...
public class GiantLightningRenderer extends EntityRenderer<GiantLightningEntity, net.minecraft.client.renderer.entity.state.EntityRenderState> {
    ...
    @Override
    public Identifier getTextureLocation(GiantLightningEntity entity) {
        return null;
    }
