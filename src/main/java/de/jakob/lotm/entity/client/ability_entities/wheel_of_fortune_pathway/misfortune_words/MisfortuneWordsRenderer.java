...
public class MisfortuneWordsRenderer extends EntityRenderer<MisfortuneWordsEntity, net.minecraft.client.renderer.entity.state.EntityRenderState> {
    ...
    @Override
    public @NotNull Identifier getTextureLocation(@NotNull MisfortuneWordsEntity entity) {
        return Identifier.fromNamespaceAndPath(LOTMCraft.MOD_ID, "textures/entity/misfortune_words/misfortune_words.png");
    }
}