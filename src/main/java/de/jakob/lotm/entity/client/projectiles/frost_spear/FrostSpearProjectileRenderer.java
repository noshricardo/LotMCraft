...
public class FrostSpearProjectileRenderer extends EntityRenderer<FrostSpearProjectileEntity, net.minecraft.client.renderer.entity.state.EntityRenderState> {
