...
public class SpearOfLightProjectileRenderer extends EntityRenderer<SpearOfLightProjectileEntity, net.minecraft.client.renderer.entity.state.EntityRenderState> {
