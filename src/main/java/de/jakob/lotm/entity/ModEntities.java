...
public class ModEntities {
    ...
    public static final Supplier<EntityType<LonginusSpearProjectileEntity>> LONGINUS_SPEAR =
            ENTITY_TYPES.register("longinus_spear", () -> EntityType.Builder.<LonginusSpearProjectileEntity>of(LonginusSpearProjectileEntity::new, MobCategory.MISC)
                    .sized(.35f, .35f).build("longinus_spear"));
    ...
    public static final Supplier<EntityType<AvalonEntity>> AVALON =
            ENTITY_TYPES.register("avalon", () -> EntityType.Builder.<AvalonEntity>of(AvalonEntity::new, MobCategory.MISC)
                    .sized(0.5F, 0.5F)
