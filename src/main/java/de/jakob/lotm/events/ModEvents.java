...
import de.jakob.lotm.entity.client.ability_entities.projectiles.longinus_spear.LonginusSpearModel;
...
public class ModEvents {
    ...
    public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(LonginusSpearModel.LAYER_LOCATION, LonginusSpearModel::createBodyLayer);
